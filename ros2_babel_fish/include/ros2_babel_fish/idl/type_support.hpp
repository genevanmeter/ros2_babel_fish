...
struct MessageMembersIntrospection
{
  /* implicit */ MessageMembersIntrospection( const MessageTypeSupport &type_support ) // NOLINT
    : library( type_support.introspection_type_support_library ), value(
    static_cast<const rosidl_typesupport_introspection_cpp::MessageMembers *>(type_support.introspection_type_support_handle.data)) { }

  /* implicit */ MessageMembersIntrospection( const MessageMemberIntrospection &member ) // NOLINT
    : library( member.library )
      , value( static_cast<const rosidl_typesupport_introspection_cpp::MessageMembers *>(member.value->members_->data))
  {
  }
...
struct ServiceTypeSupport
{
  ...
  {
    const auto *service = static_cast<const rosidl_typesupport_introspection_cpp::ServiceMembers *>(introspection_type_support_handle.data);
